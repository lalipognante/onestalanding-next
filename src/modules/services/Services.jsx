...
import icon1 from "./icon1-recortado.png";
import icon2 from "./icon2-recortado.png";
import icon3 from "./icon3-recortado.png";
import icon4 from "./icon4-recortado.png";
import icon5 from "./icon5-recortado.png";
import CardBackSide2 from '../../components/card-backside-2/CardBackSide2';
          ...
          <div className='card-container'>
            {services.map((card, index) => {
              if (card.showLearnMore) {
                return <CardBackSide2 key={card.id} card={card}/>
              } else {
